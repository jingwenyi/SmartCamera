...
typedef enum 
{
    ...
    AUDIOLIB_CHIP_AK10XX,  //snowbirds  RTOS
    AUDIOLIB_CHIP_AK10XXC, //snowbirdc  RTOS
    AUDIOLIB_CHIP_AK10XXL, //snowbirdL  RTOS
    AUDIOLIB_CHIP_AK10XXT, //SnowbirdTv2 RTOS
    AUDIOLIB_CHIP_AK11XX,  //snowbird2  RTOS
    AUDIOLIB_CHIP_AK37XX,  //sundance3  RTOS&Linux
    AUDIOLIB_CHIP_AK37XXL, //sundance3L RTOS
    AUDIOLIB_CHIP_AK37XXC, //sundance3C RTOS&Linux
    AUDIOLIB_CHIP_AK39XX,  //sundanceH  Linux
    AUDIOLIB_CHIP_AK98XX,  //Aspen3s    RTOS&Linux
    AUDIOLIB_CHIP_AK39XXE, //sundanceH2
}T_AUDIO_CHIP_ID;
