...
#define VIDEO_LIB_VERSION		"AK39 Encoder Lib V1.7.02"
...
T_VOID VideoStream_Enc_setEncPara_mainch(T_VIDEOLIB_ENC_PARA *video_enc_para);
T_VOID VideoStream_Enc_setEncPara_subch(T_VIDEOLIB_ENC_PARA *video_enc_para);
