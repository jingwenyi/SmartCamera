...
#define AK_ISP_USER_CID_SET_OSD_COLOR_TABLE_ATTR	_IOW(AKISP_MAGIC,  0x0001000a, int)
#define AK_ISP_USER_CID_SET_MAIN_CHANNEL_OSD_CONTEXT_ATTR	_IOW(AKISP_MAGIC,  0x0001000b, int)
#define AK_ISP_USER_CID_SET_SUB_CHANNEL_OSD_CONTEXT_ATTR	_IOW(AKISP_MAGIC,  0x0001000c, int)
