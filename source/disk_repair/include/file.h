 ...
 * RETURN:     AK_TRUE for success, otherwise return AK_FALSE
**************************************************************************/
T_BOOL File_GetVolumeAsc(const T_U8* DriverName,T_U8 VolumeName[12], T_U8 VolumeNameLen);
/************************************************************************
 ...
 * RETURN:     AK_TRUE for success, otherwise return AK_FALSE
**************************************************************************/
T_BOOL File_GetVolumeUnicode(const T_U16* DriverName,T_U16 VolumeName[12],T_U8 VolumeNameLen);
...
**************************************************************************/
//此接口中获取文件和文件夹的逻辑地址
T_U32 *File_GetfileclusterInfo_ToUpdate_logic( T_U32 file, T_U32 *ClusterNum, T_U32 *SecPerClus);
...
* RETURN:     t_void
**************************************************************************/
T_U32 File_FindFirst_WithID(const T_U16 *path, T_U32 *ret_cnt,  T_U16 path_buf[FIND_FILENAME_PATHLEN], T_PFINDBUFINFO find_fileinfo);
 ...
 * RETURN:     return ak_true if it is ok, otherwise return ak_false
**************************************************************************/
T_BOOL File_GetFileinfo_fastopen(T_U32 file, T_PFILEINFO_FASTOPEN fileInfo);
...
**************************************************************************/
T_U32 File_fastopen_onlyfile(T_U8 driverID, T_U32 fileID, T_U32 ParentID , T_U32 FDTOffset, T_U32 mode);
...
T_U32 File_GetDriver_StartSec(T_U8 DriverId);

 
T_BOOL File_get_chkdsk_withfolder(const T_U8 *path, T_PFOLDERINFO_CHKDSK Folder_info);
